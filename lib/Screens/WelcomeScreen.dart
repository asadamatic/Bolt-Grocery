          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0x23b574).withOpacity(.7), Color(0x23b574).withOpacity(1),]
              )
            ),
          ),
          Align(
            alignment: Alignment.center,
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('BOLT GROCERY', style: TextStyle(fontFamily: 'Roboto', fontSize: 36.0, color: Colors.white, fontWeight: FontWeight.w700),),
                ],
              ),
          ),
          Align(
